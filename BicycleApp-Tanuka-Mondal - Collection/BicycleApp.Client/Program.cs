...
namespace BicycleApp.Client
{
    internal class Program
    {
        ...
        displayAllBicycle:
            List<Bicycle> bicycle = _bicycleRepository.GetAllBicycles();
            ...
            Bicycle bicycleExistDetails = _bicycleRepository.IsBicycleExist(newBicycle);
            if (bicycleExistDetails == null)
            {
                bool eventAddStatus = _bicycleRepository.AddBicycle(newBicycle);
                Console.WriteLine(eventAddStatus);
                if (eventAddStatus)
                {
                    goto displayAllBicycle;
                }
            ...
            {
                Console.WriteLine("Event Already Exist");
                goto displayAllBicycle;
            }
            ...
            Bicycle BicycleById = bicycleRepository.GetBicycleById(id);
            if (BicycleById != null) {
            ...
            string name = Console.ReadLine();
            Bicycle BicycleByName = bicycleRepository.GetBicycleByName(name);
            ...
            Bicycle EditBicycle = bicycleRepository.GetBicycleById(editId);
            if (EditBicycle != null)
            {
        ...
        DeleteBicycle:
            ...
            Bicycle DeleteBicycle = bicycleRepository.GetBicycleById(deleteId);
